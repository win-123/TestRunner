# Generated by Django 2.1.3 on 2019-04-18 10:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.IntegerField(choices=[(1, '冒烟测试'), (2, '集成测试'), (3, '监控脚本')], default=2, verbose_name='用例标签')),
            ],
            options={
                'verbose_name': '用例信息',
                'db_table': 'Case',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '调试用例报告'), (2, '异步任务报告'), (3, '定时任务报告')], verbose_name='报告类型')),
